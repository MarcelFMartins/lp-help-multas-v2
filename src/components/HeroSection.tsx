...
export default function HeroSection() {
  ...
  useEffect(() => {
    function handler(e: MouseEvent) {
      ...
      if (capitalRef.current && !capitalRef.current.contains(e.target as Node)) setCapitalOpen(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // validações
    const required: (keyof typeof formData)[] = ["nome", "email", "whatsapp", "cidade", "uf", "capital"];
            ...
            <div className="bg-white rounded-[28px] shadow-[0_32px_70px_rgba(0,0,0,0.45)] border border-[#D4A017]/20 p-7 sm:p-10">
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-[7px]">
                  ...
                  <input
                    id="hero-nome" name="nome" type="text"
                ...
                <div className="flex flex-col gap-[7px]">
                  ...
                  <input
                    id="hero-email" name="email" type="email"
                ...
                <div className="flex flex-col gap-[7px]">
                  ...
                  <input
                    id="hero-whatsapp" name="whatsapp" type="tel"
                ...
                <div className="grid gap-3" style={{ gridTemplateColumns: "1fr 110px" }}>
                  <div className="flex flex-col gap-[7px]">
                    ...
                    <input
                      id="hero-cidade" name="cidade" type="text"
                ...
                <div className="flex flex-col gap-[7px]" ref={capitalRef}>
                  ...
                  <div className="relative">
                    ...
                    >
                      {CAPITAL_OPTIONS.find(o => o.value === formData.capital)?.label || "Selecione uma faixa"}
                      <span className={`absolute right-4 top-1/2 w-2 h-2 border-r-2 border-b-2 border-[oklch(0.1998_0.0403_258.29)]/50 transition-transform duration-200 ${capitalOpen ? "-translate-y-1/3 rotate-[225deg]" : "-translate-y-2/3 rotate-45"}`} />
                    </button>
                      ...
                      >
                        {CAPITAL_OPTIONS.map(opt => (
                          <button
                            ...
                            className={`w-full text-left px-3 py-2.5 rounded-[10px] text-[15px] transition-colors duration-150
                              ${formData.capital === opt.value ? "bg-[#D4A017]/15 text-[#D4A017] font-bold" : "text-[oklch(0.1998_0.0403_258.29)] hover:bg-[#edf2f6]"}`}
                            onClick={() => { setFormData(p => ({ ...p, capital: opt.value })); setCapitalOpen(false); }}
                          >
                            {opt.label}
                          </button>
                        ))}
